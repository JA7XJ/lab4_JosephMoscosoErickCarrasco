    ...
    public static void main(String[] args) {
        ...
        while (c == 1) {
            ...
            if (op == 4) {
                ...
                int turn = 1;
                ImpMatrix(Radar1, 0, 0);
                do {
                    if (turn == 1) {
                        System.out.println("User 1 turns");
                        System.out.println("Ingrese x de una pieza: ");
                        int x = sc.nextInt();
                        System.out.println("Ingrese y de una pieza: ");
                        int y = sc.nextInt();
                        if ("PM".equals(Radar1[x][y])) {
                            evapm m=new evapm();
                            Radar1=m.movimiento(Radar1, 3, 3, x, y);
                            ImpMatrix(Radar1, 0,0);
                        }
                    }
